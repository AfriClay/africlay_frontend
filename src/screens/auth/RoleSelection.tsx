...
export const RoleSelection: React.FC = () => {
  ...
  const [selectedRole, setSelectedRole] = useState<'seller' | 'both' | null>(null);
  ...
  return (
    <View style={styles.container}>
      ...
      {roles.map(role => (
        <Pressable key={role.id} style={styles.card} onPress={() => handleSelect(role.id as any)} accessibilityRole="button" accessibilityLabel={role.title}>
